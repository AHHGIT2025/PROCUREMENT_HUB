...
import { i as require_browser_external_path, n as require_browser_external_url, r as require_browser_external_fs } from "./vite.js";
...
//#endregion
//#region browser-external:source-map-js
var require_browser_external_source_map_js = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "source-map-js" has been externalized for browser compatibility. Cannot access "source-map-js.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
//#region node_modules/postcss/lib/previous-map.js
var require_previous_map = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var { existsSync, readFileSync } = require_browser_external_fs();
	var { dirname, join } = require_browser_external_path();
	var { SourceMapConsumer, SourceMapGenerator } = require_browser_external_source_map_js();
...
var require_input = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var { isAbsolute, resolve } = require_browser_external_path();
	var { SourceMapConsumer, SourceMapGenerator } = require_browser_external_source_map_js();
	var { fileURLToPath, pathToFileURL } = require_browser_external_url();
	var CssSyntaxError = require_css_syntax_error();
...
var require_map_generator = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	var { dirname, relative, resolve, sep } = require_browser_external_path();
	var { SourceMapConsumer, SourceMapGenerator } = require_browser_external_source_map_js();
	var { pathToFileURL } = require_browser_external_url();
	var Input = require_input();
	var sourceMapAvailable = Boolean(SourceMapConsumer && SourceMapGenerator);
...
//# sourceMappingURL=postcss-C09vbj0T.js.map