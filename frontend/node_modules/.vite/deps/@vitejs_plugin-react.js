...
import { I as viteReactRefreshWrapperPlugin, J as require_browser_external_node_url, Y as require_browser_external_node_fs, _ as makeIdFiltersToMatchWithQuery, g as exactRegex } from "./experimental-index-B3upstUZ.js";
import { t as require_browser_external_node_path } from "./browser-external_node_path-BSAc3z5V.js";
//#region node_modules/vite/dist/node/internal.js
var import_browser_external_node_fs = /* @__PURE__ */ __toESM(require_browser_external_node_fs(), 1);
var import_browser_external_node_path = /* @__PURE__ */ __toESM(require_browser_external_node_path(), 1);
...
var reactCompilerPreset = (options = {}) => ({
...
var refreshRuntimePath = (0, import_browser_external_node_path.join)((0, import_browser_external_node_path.dirname)((0, import_browser_external_node_url.fileURLToPath)(import.meta.url)), "refresh-runtime.js");
var defaultIncludeRE = /\.[tj]sx?$/;
var defaultExcludeRE = /\/node_modules\//;
function viteReact(opts = {}) {
	...
	const viteRefreshWrapper = {
		...
		async applyToEnvironment(env) {
			...
			return viteReactRefreshWrapperPlugin({
				cwd: process.cwd(),
	...
	return [
		...
		viteReactRefreshBundledDevMode,
		{
			...
			load: {
				filter: { id: exactRegex(runtimePublicPath) },
				handler(id) {
					if (id === "/@react-refresh") return (0, import_browser_external_node_fs.readFileSync)(refreshRuntimePath, "utf-8").replace(/__README_URL__/g, "https://github.com/vitejs/vite-plugin-react/tree/main/packages/plugin-react");
				}
			},
			transformIndexHtml() {
				if (!skipFastRefresh && !isBundledDev) return [{
