...
import { d as require_browser_external_node_tty, f as require_browser_external_node_process } from "./experimental-index-B3upstUZ.js";
import { t as require_browser_external_node_readline } from "./browser-external_node_readline-HrGDMiVR.js";
//#region node_modules/rolldown/dist/shared/prompt-DewH0PjV.mjs
var import_browser_external_node_process = /* @__PURE__ */ __toESM(require_browser_external_node_process(), 1);
var import_browser_external_node_tty = /* @__PURE__ */ __toESM(require_browser_external_node_tty(), 1);
var import_browser_external_node_readline = /* @__PURE__ */ __toESM(require_browser_external_node_readline(), 1);
...
var e = /* @__PURE__ */ getDefaultExportFromCjs(/* @__PURE__ */ requirePicocolors());
...
var m = 10, L$1 = (t = 0) => (u) => `\x1B[${u + t}m`, N = (t = 0) => (u) => `\x1B[${38 + t};5;${u}m`, I = (t = 0) => (u, F, e) => `\x1B[${38 + t};2;${u};${F};${e}m`, r = {
	modifier: {
		reset: [0, 0],
		bold: [1, 22],
		dim: [2, 22],
...
var tD = Object.keys(r.color), eD = Object.keys(r.bgColor);
[...tD, ...eD];
function sD() {
...
var iD = sD(), v = new Set(["\x1B", ""]), CD = 39, w$1 = "\x07", W$1 = "[", rD = "]", R = "m", y = `${rD}8;;`, V$1 = (t) => `${v.values().next().value}${W$1}${t}${R}`, z = (t) => `${v.values().next().value}${y}${t}${w$1}`, ED = (t) => t.split(" ").map((u) => A$1(u)), _ = (t, u, F) => {
	const e = [...u];
...
var x = class {
	constructor(u, F = true) {
		...
		const { input: e = import_browser_external_node_process.stdin, output: s = import_browser_external_node_process.stdout, render: i, signal: D, ...C } = u;
	...
	prompt() {
		return new Promise((u, F) => {
			...
			const e = new import_browser_external_node_tty.WriteStream(0);
			e._write = (s, i, D) => {
				this._track && (this.value = this.rl?.line.replace(/\t/g, ""), this._cursor = this.rl?.cursor ?? 0, this.emit("value", this.value)), D();
			}, this.input.pipe(e), this.rl = import_browser_external_node_readline.default.createInterface({
				input: this.input,
				output: e,
				tabSize: 2,
				prompt: "",
				escapeCodeTimeout: 50
			}), import_browser_external_node_readline.default.emitKeypressEvents(this.input, this.rl), this.rl.prompt(), this.opts.initialValue !== void 0 && this._track && this.rl.write(this.opts.initialValue), this.input.on("keypress", this.onKeypress), d$1(this.input, true), this.output.on("resize", this.render), this.render(), this.once("submit", () => {
...
function ce() {
	return import_browser_external_node_process.default.platform !== "win32" ? import_browser_external_node_process.default.env.TERM !== "linux" : !!import_browser_external_node_process.default.env.CI || !!import_browser_external_node_process.default.env.WT_SESSION || !!import_browser_external_node_process.default.env.TERMINUS_SUBLIME || import_browser_external_node_process.default.env.ConEmuTask === "{cmd::Cmder}" || import_browser_external_node_process.default.env.TERM_PROGRAM === "Terminus-Sublime" || import_browser_external_node_process.default.env.TERM_PROGRAM === "vscode" || import_browser_external_node_process.default.env.TERM === "xterm-256color" || import_browser_external_node_process.default.env.TERM === "alacritty" || import_browser_external_node_process.default.env.TERMINAL_EMULATOR === "JetBrains-JediTerm";
}
var V = ce(), u = (t, n) => V ? t : n, le = u("❯", ">"), L = u("■", "x"), W = u("▲", "x"), C = u("✔", "√"), o = u(""), d = u(""), k = u("●", ">"), P = u("○", " "), A = u("◻", "[•]"), T = u("◼", "[+]"), F = u("◻", "[ ]"), w = (t) => {
	switch (t) {
		case "initial":
...
//# sourceMappingURL=prompt-DewH0PjV-B4p_iJ_m.js.map