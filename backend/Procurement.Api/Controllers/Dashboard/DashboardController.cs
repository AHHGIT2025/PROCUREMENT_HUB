...
namespace Procurement.Api.Controllers.Dashboard
{
    ...
    public class DashboardController : ControllerBase
    {
        ...
        public async Task<IActionResult> Get()
        {
            ...
            // ✅ FIXED: Procurement Manager, Company GM, Vice Chairman added.
            // ✅ FIXED: DCEO added — previously missing here meant a DCEO
            // user's own pending approvals never showed on their dashboard
            // (myPendingApprovals / pendingApprovalQueue below both key off
            // isApprover), even though their tasks were correctly visible
            // on the Approvals page itself (which uses a different query).
            var isApprover = userRoles.Any(r =>
                r is "Manager" or "IT Manager" or "Budget Manager" or
                    "Asset Manager" or "Finance Approver" or "Procurement Officer" or
                    "Procurement Manager" or
                    "Company GM" or "Vice Chairman" or
                    "CEO" or "DCEO" or "Approver" or "System Admin");
            ...
            // they've explicitly been granted access to (UserCompanies) —
            // they must not see other divisions' requests/approvals.
            // NOTE: DCEO intentionally NOT added here — DCEO keeps
            // company-scoped visibility (per UserCompanies), only their own
            // pending-approvals visibility was the reported issue.
            var isHoldingWideRole = userRoles.Any(r =>
                r is "CEO" or "Company GM" or "Vice Chairman" or "System Admin");
