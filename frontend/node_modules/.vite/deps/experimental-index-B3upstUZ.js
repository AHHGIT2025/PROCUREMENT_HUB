import { i as __toESM$1, t as __commonJSMin$1 } from "./chunk-B4lejLz5.js";
import { t as require_browser_external_node_module } from "./browser-external_node_module-CXQIxqfg.js";
import { t as require_browser_external_node_path } from "./browser-external_node_path-BSAc3z5V.js";
//#region browser-external:node:fs
var require_browser_external_node_fs = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
...
var require_browser_external_node_url = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
...
//#endregion
//#region node_modules/rolldown/dist/shared/logs-aMKUxRpj.mjs
var import_browser_external_node_module = require_browser_external_node_module();
...
var INVALID_LOG_POSITION = "INVALID_LOG_POSITION", PLUGIN_ERROR = "PLUGIN_ERROR", INPUT_HOOK_IN_OUTPUT_PLUGIN = "INPUT_HOOK_IN_OUTPUT_PLUGIN", CYCLE_LOADING = "CYCLE_LOADING", MULTIPLE_WATCHER_OPTION = "MULTIPLE_WATCHER_OPTION", PARSE_ERROR = "PARSE_ERROR";
...
//#endregion
//#region node_modules/rolldown/dist/shared/binding-lLxFxuG-.mjs
...
var __require = /* @__PURE__ */ (0, import_browser_external_node_module.createRequire)(import.meta.url);
...
//#endregion
//#region node_modules/rolldown/dist/shared/parse-DRL-bdRR.mjs
...
async function parse(filename, sourceText, options) {
	return wrap$1(await (0, import_binding$5.parse)(filename, sourceText, options));
}
/**
...
function parseSync(filename, sourceText, options) {
	return wrap$1((0, import_binding$5.parseSync)(filename, sourceText, options));
}
//#endregion
//#region node_modules/rolldown/dist/parse-ast-index.mjs
...
//#endregion
//#region node_modules/rolldown/dist/shared/normalize-string-or-regex-DqWsYC5b.mjs
...
function makeBuiltinPluginCallable(plugin) {
	let callablePlugin = new import_binding$4.BindingCallableBuiltinPlugin(bindingifyBuiltInPlugin(plugin));
...
//#endregion
//#region node_modules/rolldown/dist/shared/constructors-BWzinPZW.mjs
var import_browser_external_node_path = /* @__PURE__ */ __toESM$1(require_browser_external_node_path(), 1);
...
//#endregion
//#region node_modules/rolldown/dist/shared/error-B8po7KiL.mjs
...
//#endregion
//#region node_modules/rolldown/dist/shared/resolve-tsconfig-B5gzX9_3.mjs
...
async function minify(filename, sourceText, options) {
	const inputMap = bindingifySourcemap$1(options?.inputMap);
	const result = await (0, import_binding$3.minify)(filename, sourceText, options);
	if (result.map && inputMap) result.map = {
		version: 3,
		...(0, import_binding$3.collapseSourcemaps)([inputMap, bindingifySourcemap$1(result.map)])
	};
	return result;
}
/**
...
function minifySync(filename, sourceText, options) {
	const inputMap = bindingifySourcemap$1(options?.inputMap);
	const result = (0, import_binding$3.minifySync)(filename, sourceText, options);
	if (result.map && inputMap) result.map = {
		version: 3,
		...(0, import_binding$3.collapseSourcemaps)([inputMap, bindingifySourcemap$1(result.map)])
	};
...
function transformSync(filename, sourceText, options, cache) {
	const result = (0, import_binding$3.enhancedTransformSync)(filename, sourceText, options, cache, yarnPnp$1);
	return {
		...result,
...
* @experimental
*/
var TsconfigCache = class extends import_binding$3.TsconfigCache {
	constructor() {
		super(yarnPnp);
	}
};
...
function resolveTsconfig(filename, cache) {
	return (0, import_binding$3.resolveTsconfig)(filename, cache, yarnPnp);
}
//#endregion
//#region browser-external:node:fs/promises
var require_promises = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
...
//#endregion
//#region browser-external:node:util
var require_browser_external_node_util = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "node:util" has been externalized for browser compatibility. Cannot access "node:util.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
//#region node_modules/rolldown/dist/shared/misc-CoQm4NHO.mjs
...
//#endregion
//#region node_modules/rolldown/dist/shared/bindingify-input-options-DmY7myA4.mjs
var import_promises = /* @__PURE__ */ __toESM$1(require_promises(), 1);
/**
...
var LAZY_FIELDS_KEY = Symbol("__lazy_fields__");
/**
...
Object.defineProperty(import_binding$2.BindingMagicString.prototype, "isRolldownMagicString", {
	value: true,
	writable: false,
	configurable: false
});
...
var nativeAppend = import_binding$2.BindingMagicString.prototype.append;
var nativePrepend = import_binding$2.BindingMagicString.prototype.prepend;
var nativeAppendLeft = import_binding$2.BindingMagicString.prototype.appendLeft;
var nativeAppendRight = import_binding$2.BindingMagicString.prototype.appendRight;
var nativePrependLeft = import_binding$2.BindingMagicString.prototype.prependLeft;
var nativePrependRight = import_binding$2.BindingMagicString.prototype.prependRight;
var nativeOverwrite = import_binding$2.BindingMagicString.prototype.overwrite;
var nativeUpdate = import_binding$2.BindingMagicString.prototype.update;
import_binding$2.BindingMagicString.prototype.append = function(content) {
	assertString(content, "outro content must be a string");
	return nativeAppend.call(this, content);
};
import_binding$2.BindingMagicString.prototype.prepend = function(content) {
	assertString(content, "outro content must be a string");
	return nativePrepend.call(this, content);
};
import_binding$2.BindingMagicString.prototype.appendLeft = function(index, content) {
	assertString(content, "inserted content must be a string");
	return nativeAppendLeft.call(this, index, content);
};
import_binding$2.BindingMagicString.prototype.appendRight = function(index, content) {
	assertString(content, "inserted content must be a string");
	return nativeAppendRight.call(this, index, content);
};
import_binding$2.BindingMagicString.prototype.prependLeft = function(index, content) {
	assertString(content, "inserted content must be a string");
	return nativePrependLeft.call(this, index, content);
};
import_binding$2.BindingMagicString.prototype.prependRight = function(index, content) {
	assertString(content, "inserted content must be a string");
	return nativePrependRight.call(this, index, content);
};
import_binding$2.BindingMagicString.prototype.overwrite = function(start, end, content, options) {
	assertString(content, "replacement content must be a string");
	return nativeOverwrite.call(this, start, end, content, options);
};
import_binding$2.BindingMagicString.prototype.update = function(start, end, content, options) {
	assertString(content, "replacement content must be a string");
	return nativeUpdate.call(this, start, end, content, options);
};
var nativeReplace = import_binding$2.BindingMagicString.prototype.replace;
var nativeReplaceAll = import_binding$2.BindingMagicString.prototype.replaceAll;
import_binding$2.BindingMagicString.prototype.replace = function(searchValue, replacement) {
...
import_binding$2.BindingMagicString.prototype.replaceAll = function(searchValue, replacement) {
...
* @experimental
*/
var RolldownMagicString = import_binding$2.BindingMagicString;
...
function transformFilterMatcherToFilterExprs(filterOption) {
	...
	let codeIncludes = [];
	let codeExcludes = [];
	if (id) [idIncludes, idExcludes] = t$2(generalHookFilterMatcherToFilterExprs(id, "id") ?? [], (m) => m.kind === "include");
	if (code) [codeIncludes, codeExcludes] = t$2(generalHookFilterMatcherToFilterExprs(code, "code") ?? [], (m) => m.kind === "include");
	ret.push(...idExcludes);
...
function preProcessSourceMap(ret, id) {
	...
	if (!isEmptySourcemapFiled(map.sources)) {
		const directory = import_browser_external_node_path.default.dirname(id) || ".";
		const sourceRoot = map.sourceRoot || ".";
		map.sources = map.sources.map((source) => import_browser_external_node_path.default.resolve(directory, sourceRoot, source));
	}
	return map;
}
...
function bindingifyAttachDebugInfo(attachDebugInfo) {
	switch (attachDebugInfo) {
		case void 0: return;
		case "full": return import_binding$2.BindingAttachDebugInfo.Full;
		case "simple": return import_binding$2.BindingAttachDebugInfo.Simple;
		case "none": return import_binding$2.BindingAttachDebugInfo.None;
	}
}
...
function bindingifyExperimental(experimental) {
	let chunkModulesOrder = import_binding$2.BindingChunkModuleOrderBy.ExecOrder;
	if (experimental?.chunkModulesOrder) switch (experimental.chunkModulesOrder) {
		case "exec-order":
			chunkModulesOrder = import_binding$2.BindingChunkModuleOrderBy.ExecOrder;
			break;
		case "module-id":
			chunkModulesOrder = import_binding$2.BindingChunkModuleOrderBy.ModuleId;
			break;
...
function bindingifyTreeshakeOptions(config) {
	...
	switch (config.propertyReadSideEffects) {
		case "always":
			normalizedConfig.propertyReadSideEffects = import_binding$2.BindingPropertyReadSideEffects.Always;
			break;
		case false:
			normalizedConfig.propertyReadSideEffects = import_binding$2.BindingPropertyReadSideEffects.False;
			break;
		default:
	}
	switch (config.propertyWriteSideEffects) {
		case "always":
			normalizedConfig.propertyWriteSideEffects = import_binding$2.BindingPropertyWriteSideEffects.Always;
			break;
		case false:
			normalizedConfig.propertyWriteSideEffects = import_binding$2.BindingPropertyWriteSideEffects.False;
			break;
		default:
	}
...
//#endregion
//#region browser-external:node:worker_threads
var require_browser_external_node_worker_threads = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
...
//#endregion
//#region browser-external:node:process
var require_browser_external_node_process = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "node:process" has been externalized for browser compatibility. Cannot access "node:process.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
//#region browser-external:node:tty
var require_browser_external_node_tty = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "node:tty" has been externalized for browser compatibility. Cannot access "node:tty.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
//#region browser-external:node:os
var require_browser_external_node_os = /* @__PURE__ */ __commonJSMin$1(((exports, module) => {
	module.exports = Object.create(new Proxy({}, { get(_, key) {
		if (key !== "__esModule" && key !== "__proto__" && key !== "constructor" && key !== "splice") console.warn(`Module "node:os" has been externalized for browser compatibility. Cannot access "node:os.${key}" in client code. See https://vite.dev/guide/troubleshooting.html#module-externalized-for-browser-compatibility for more details.`);
	} }));
}));
//#endregion
//#region node_modules/rolldown/dist/shared/rolldown-build-9MccaWPU.mjs
var import_browser_external_node_worker_threads = require_browser_external_node_worker_threads();
var import_browser_external_node_util = require_browser_external_node_util();
var import_browser_external_node_process = /* @__PURE__ */ __toESM$1(require_browser_external_node_process(), 1);
var import_browser_external_node_tty = /* @__PURE__ */ __toESM$1(require_browser_external_node_tty(), 1);
var import_browser_external_node_os = /* @__PURE__ */ __toESM$1(require_browser_external_node_os(), 1);
...
function relativeId(id) {
	if (!import_browser_external_node_path.default.isAbsolute(id)) return id;
	return import_browser_external_node_path.default.relative(import_browser_external_node_path.default.resolve(), id);
}
...
function styleText$1(...args) {
	return (0, import_browser_external_node_util.styleText)(...args);
}
...
function parseStack(stack, message) {
	const cwd = process.cwd() + import_browser_external_node_path.sep;
...
${indent}`);
	...
	formatError(err, opts) {
		const message = err.message ?? (0, import_browser_external_node_util.formatWithOptions)(opts, err);
	...
	formatArgs(args, opts) {
		return (0, import_browser_external_node_util.formatWithOptions)(opts, ...args.map((arg) => {
...
var isCompatibleTerminal = import_browser_external_node_tty && import_browser_external_node_tty.isatty && import_browser_external_node_tty.isatty(1) && env.TERM && !isDumbTerminal;
...
var r = Object.create(null), i = (e) => globalThis.process?.env || import.meta.env || globalThis.Deno?.env.toObject() || globalThis.__env__ || (e ? r : globalThis), o = new Proxy(r, {
	get(e, s) {
		return i()[s] ?? r[s];
	},
	has(e, s) {
...
}), t = typeof process < "u" && process.env && "development" || "", f = [
	["APPVEYOR"],
	[
		"AWS_AMPLIFY",
		"AWS_APP_ID",
...
var I = globalThis.process?.platform || "", T = n(o.CI) || l.ci !== false, a = n(globalThis.process?.stdout && globalThis.process?.stdout.isTTY), g = n(o.DEBUG), R = t === "test" || n(o.TEST);
o.MINIMAL;
var A = /^win/i.test(I);
!n(o.NO_COLOR) && (n(o.FORCE_COLOR) || (a || A) && o.TERM);
var C = (globalThis.process?.versions?.node || "").replace(/^v/, "") || null;
Number(C?.split(".")[0]);
var y = globalThis.process || Object.create(null), _ = { versions: {} };
new Proxy(y, { get(e, s) {
	if (s === "env") return o;
	if (s in e) return e[s];
	if (s in _) return _[s];
} });
var c = globalThis.process?.release?.name === "node", O = !!globalThis.Bun || !!globalThis.process?.versions?.bun, D = !!globalThis.Deno, L = !!globalThis.fastly, S = !!globalThis.Netlify, u = !!globalThis.EdgeRuntime, N = globalThis.navigator?.userAgent === "Cloudflare-Workers", F = [
	[S, "netlify"],
	[u, "edge-light"],
	[N, "workerd"],
	[L, "fastly"],
...
function isUnicodeSupported() {
	const { env } = import_browser_external_node_process.default;
	const { TERM, TERM_PROGRAM } = env;
	if (import_browser_external_node_process.default.platform !== "win32") return TERM !== "linux";
...
function createConsola(options = {}) {
	...
	return createConsola$1({
		...
		prompt: (...args) => import("./prompt-DewH0PjV-B4p_iJ_m.js").then((m) => m.prompt(...args)),
...
async function initializeWorker(registryId, pluginInfos, threadNumber) {
	...
	let worker;
	try {
		worker = new import_browser_external_node_worker_threads.Worker(new URL(urlString), { workerData });
		worker.unref();
...
var availableParallelism = () => {
	...
	try {
		availableParallelism = import_browser_external_node_os.default.availableParallelism();
	} catch {
		const cpus = import_browser_external_node_os.default.cpus();
...
var RolldownBuild = class RolldownBuild {
	...
	constructor(inputOptions) {
		...
		this.#bundler = new import_binding$1.BindingBundler();
	}
	/**
...
//#endregion
export { viteBuildImportAnalysisPlugin as A, viteWebWorkerPostPlugin as B, minify as C, aggregateBindingErrorsIntoJsError as D, transformSync as E, viteModulePreloadPolyfillPlugin as F, __toESM as G, parseAstAsync as H, viteReactRefreshWrapperPlugin as I, require_browser_external_node_url as J, require_binding as K, viteReporterPlugin as L, viteImportGlobPlugin as M, viteJsonPlugin as N, esmExternalRequirePlugin as O, viteLoadFallbackPlugin as P, viteResolvePlugin as R, TsconfigCache as S, resolveTsconfig as T, parse as U, parseAst as V, parseSync as W, require_browser_external_node_fs as Y, makeIdFiltersToMatchWithQuery as _, viteTransformPlugin as a, require_browser_external_node_util as b, createBundlerOptions as c, require_browser_external_node_tty as d, require_browser_external_node_process as f, exactRegex as g, VERSION as h, viteManifestPlugin as i, viteDynamicImportVarsPlugin as j, oxcRuntimePlugin as k, validateOption as l, LOG_LEVEL_WARN as m, scan as n, PluginDriver as o, require_browser_external_node_worker_threads as p, logMultipleWatcherOption as q, viteAliasPlugin as r, RolldownBuild as s, dev as t, require_browser_external_node_os as u, arraify as v, minifySync as w, require_promises as x, isPromiseLike as y, viteWasmFallbackPlugin as z };

//# sourceMappingURL=experimental-index-B3upstUZ.js.map